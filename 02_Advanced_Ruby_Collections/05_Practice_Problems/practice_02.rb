...
# --------------------------------------------------------------------------- #
#
# Question: How would you order this array of hashes based on the year of
...
sorted_by_year = books.sort_by { |book| book[:published] }
sorted_by_year.each { |book| puts ":published=>\"#{book[:published]}\"" }
puts "\n", sorted_by_year, "\n"
